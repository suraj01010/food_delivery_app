...
public class PassangerOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterItem1=new ArrayAdapter<String>(PassangerOrder.this,R.layout.list_item,addarray);
        ...
        adapterItem2=new ArrayAdapter<String>(PassangerOrder.this,R.layout.list_item,addarray);
        ...
        adapterItem3=new ArrayAdapter<String>(PassangerOrder.this,R.layout.list_item,addarray);
        ...
        adapterItem4=new ArrayAdapter<String>(PassangerOrder.this,R.layout.list_item,addarray);
        ...
        adapterItem5=new ArrayAdapter<String>(PassangerOrder.this,R.layout.list_item,addarray);
